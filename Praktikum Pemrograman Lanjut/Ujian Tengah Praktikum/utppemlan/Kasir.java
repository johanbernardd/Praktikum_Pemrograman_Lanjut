...
public class Kasir {
    ...
    public void tampilkanDaftarMeja() {
        ...
        for (int i = 0; i < daftarMeja.length; i++) {
            Meja table = daftarMeja[i];
            if (table.isKosong()) {
                System.out.println("Meja " + table.getNomorMeja() + "(kosong)");
            } else {
                System.out.println("Meja " + table.getNomorMeja() + "(terisi oleh pelanggan )" + table.getPelanggan().getNama());
            }
        }
    }
        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    tambahPelanggan(nomorMeja, new Pelanggan(namaPel));
                    break;
                case 3:
                ...
                case 5:
                    ...
                    if (harga > 0) {
                        System.out.println("Harga pesanan di meja " + nomorMeja + " adalah " + harga);
                    } else {
                        System.out.println("Meja " + nomorMeja + " tidak memiliki pesanan");
                    }
                    break;
