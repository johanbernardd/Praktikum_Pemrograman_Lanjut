...
public class Overloading {
    ...
    int nilai = a * b;
    System.out.println("maka hasil luas dari method HitungLuas berparameter int a dan b : " + nilai); 
    }

    public static void HitungLuas(double value, double value2) { 
    double nilai = value * value2; 
    System.out.println("maka hasil luas dari method HitungLuas berparameter double value dan value2 : " + nilai);
    }
